...
php artisan twitter:giveaway --exclude=someuser --exclude=@otheruser</pre>
                    ...
                    <div class="mt-4 mb-4">
                        ...
                        <br />
                        @php dump(collect(['someuser', '@otheruser', 'iamuser'])) @endphp
                    </div>
                    ...
                    <div class="mt-4 mb-4">
                        ...
                        <br />
                        @php dump(collect(['someuser', '@otheruser', 'iamuser'])->push('iamuser2', 'povilaskorop', '@dailylaravel')) @endphp
                    </div>
                    ...
                    <div class="mt-4 mb-4">
                        ...
                        <br />
                        @php dump(collect(['someuser', '@otheruser', 'iamuser'])->push('iamuser2', 'povilaskorop', '@dailylaravel')->map(fn (string $name): string => str_replace('@', '', $name))) @endphp
                    </div>
                    ...
                    <div class="mt-4 mb-4">
                        ...
                        <br />
                        @php dump(collect(['someuser', '@otheruser', 'iamuser'])->push('iamuser2', 'povilaskorop', '@dailylaravel')->map(fn (string $name): string => str_replace('@', '', $name))->implode(', ')) @endphp
                    </div>
